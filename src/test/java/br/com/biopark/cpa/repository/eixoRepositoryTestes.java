...
@DataJpaTest
public class eixoRepositoryTestes {
    ...
    public void testePersistenciaEixo() throws Exception {
        ...
        Pergunta banco = new Pergunta("Qual banco de dados nós usamos?", TipoPergunta.AVALIATIVA, true);
        ...
        //Eixo persistidoEixo = (Eixo) eixoRepository.findByNome(eixo.getNome(), pageable);
        Eixo persistidoEixo = eixoRepository.findByNome(eixo.getNome(), pageable).getContent().get(0);

        Pergunta persistidoPergunta = perguntaRepository.findByTexto(banco.getTexto());
